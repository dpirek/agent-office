...
function createOfficeTasksTool({ uiStateStore, subAgentManager }) {
  ...
  return {
    ...
    parameters: objectSchema({
      ...
      description: { type: ["string", "null"], description: "Detailed instructions for create: objective, relevant context, constraints, deliverables, and acceptance criteria. Provide enough detail for the worker to act without the conversation." },
