...
export function createWebSocketHandler({
  ...
  return function handleWebSocket(socket, req) {
    ...
    const recordConnection = (state, detail = "") => {
      ...
      if (state === "disconnected") connectionClosed = true;
    ...
    socket.on("end", () => recordConnection("disconnected", "Network stream ended."));
    socket.on("error", (error) => recordConnection("disconnected", error.message));
