...
class SubAgentManager {
  constructor({ getMessageContext = () => null, prepareTask = null, createMcpConnection = () => null, onTaskAssigned = () => {}, onTaskEvent = () => {}, onDirectMessage = () => {}, onDirectMessageSent = () => {}, onWorkerRegistered = () => {}, onWorkerDisconnected = () => {}, createArtifactUpload = () => null, discardArtifactUploads = async () => {}, materializeArtifacts = async (_task, work) => work } = {}) {
  ...
  receiveUpdate(agent, payload, connectionId) {
    ...
    return Promise.resolve().then(() => this.materializeArtifacts({ ...record }, work, uploadedArtifactIds)).then((storedWork) => {
