...
- Persist actionable work with manage_office_tasks before reporting that tasks are created or assigned. A plan written in chat is not a task record. Use assign for existing task IDs; delegate_to_sub_agent creates a new tracked task.
