...
export function createOfficeTask(uiStateStore, { title, priority = "medium", projectId = "central-office", dependsOn, depends_on: dependsOnSnake } = {}) {
  ...
  return uiStateStore.createOfficeTask({ title: normalizedTitle, priority: normalizedPriority, dependsOn: dependencyIds, projectId });
}
