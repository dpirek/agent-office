...
export function createUiStateStore(databasePath) {
  ...
  return {
    ...
    getProjects() {
      return database.prepare("SELECT id, name, description, status, created_at AS createdAt, updated_at AS updatedAt FROM projects ORDER BY created_at, id").all();
    },
    ...
    createProject({ name, description = "" } = {}) {
      ...
      database.prepare("INSERT INTO projects (id, name, description, created_at, updated_at) VALUES (?, ?, ?, ?, ?)").run(id, normalized, String(description), now, now);
