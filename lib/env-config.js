...
const TOOL_ENV_KEYS = {
  manage_office_tasks: "AI_HARNESS_TOOL_MANAGE_OFFICE_TASKS",
  read_office_memory: "AI_HARNESS_TOOL_READ_OFFICE_MEMORY",
...
export function liveLoggingEnabled(env = process.env) {
  return environmentBoolean(env, 'AI_HARNESS_LIVE_LOGGING') ?? true;
}
