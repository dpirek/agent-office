...
const publicUser = (row) => row ? { id: row.id, email: row.email, name: row.name, avatar: row.avatar, role: row.role, disabled: Boolean(row.disabled), createdAt: row.created_at } : null;
