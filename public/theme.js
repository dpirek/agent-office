...
(() => {
  ...
  const themes = { terminal: { label: 'Terminal', color: '#080c0e', logo: '/logo.svg' }, teams: { label: 'Teams', color: '#5055a0', logo: '/logo-teams.svg' }, matrix: { label: 'Matrix', color: '#001008', logo: '/logo-matrix.svg' }, sakura: { label: 'Sakura', color: '#282942', logo: '/logo-sakura.svg' } };
